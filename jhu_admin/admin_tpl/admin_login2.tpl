...
<!DOCTYPE html>
<!--Create a nice login form using CSS3 and HTML5-->
<html>
<head>
<title>Log In-JohnnyHu's blog</title>
<style>
...
<form id="login" method="post" action="{{action}}">
    <h1>LOG IN</h1>
    <fieldset id="inputs">
        <input type="text" id="username" name="usrname" placeholder="Username" autofocus required>   
    ...
    <a href="http://localhost/" id="back">Back to homepage...</a>
</form>
