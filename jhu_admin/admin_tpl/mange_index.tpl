...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎使用JHULOG博客程序，建博的首选工具。</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    ...
                    <a href="/newposts"><i class="icon-font">&#xe005;</i>新增博文</a>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">官方交流网站：</label><span class="res-info"><a href="#" target="_blank">JHULOG</a></span>
                    </li>
                    <li>
                        <label class="res-lab">官方交流QQ群：</label>
						<span class="res-info"><a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=7bc8695e9153c62af4fdb53456ce3fc42a8e5e4706587a7f4dd0215078bb347b"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="JHULOG交流群" title="JHULOG交流群"></a> 
						</span>
                    </li>
                </ul>
            </div>
